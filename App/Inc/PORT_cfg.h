...
#define UART2_RX_PIN    0        //PTD2
#define UART2_TX_PIN    0        //PTD3
...
#define FTM0_CH5_PIN    0        //PTD5、PTA0            PTA0不要用（与Jtag、SWD冲突）
#define FTM0_CH6_PIN    0        //PTD6、PTA1            PTA1不要用（与Jtag冲突）
#define FTM0_CH7_PIN    0        //PTD7、PTA2            PTA2不要用（与Jtag冲突）
...
#define FTM3_CH0_PIN    0        //PTE5                   PTD0
...
#define I2C1_SCL_PIN    PTE1       // PTE1、PTC10
#define I2C1_SDA_PIN    PTE0       // PTE0、PTC11
...
#define SPI0_SCK_PIN    0       // PTA15、PTC5、PTD1        全部都是 ALT2
#define SPI0_SOUT_PIN   0       // PTA16、PTC6、PTD2        全部都是 ALT2
#define SPI0_SIN_PIN    0       // PTA17、PTC7、PTD3        全部都是 ALT2

#define SPI0_PCS0_PIN   0       // PTA14、PTC4、PTD0、      全部都是 ALT2
#define SPI0_PCS1_PIN   0        // PTC3、PTD4               全部都是 ALT2
#define SPI0_PCS2_PIN   0        // PTC2、PTD5               全部都是 ALT2
#define SPI0_PCS3_PIN   0        // PTC1、PTD6               全部都是 ALT2
#define SPI0_PCS4_PIN   0        // PTC0、                   全部都是 ALT2
#define SPI0_PCS5_PIN   0       // PTB23                    ALT3
...
#define SPI1_PCS1_PIN   0        // PTE0、PTB9、             全部都是 ALT2
#define SPI1_PCS2_PIN   0        // PTE5、                   全部都是 ALT2
#define SPI1_PCS3_PIN   0        // PTE6、                   全部都是 ALT2
...
#define SPI2_PCS1_PIN   0       // PTD15                    全部都是 ALT2


/**********************************  CAN   ***************************************/
#define CAN0_TX_PIN     0       //PTA12、PTB18              全部都是 ALT2
#define CAN0_RX_PIN     0       //PTA13、PTB19              全部都是 ALT2

#define CAN1_TX_PIN     0       //PTE24、PTC17              全部都是 ALT2
#define CAN1_RX_PIN     0       //PTE25、PTC16              全部都是 ALT2
